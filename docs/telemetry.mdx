...
We also provide the option to export telemetry data to your own observability tools. You can export our telemetry to your own Otel Collector setup by running the following command:
<Tabs>
  <TabItem value="linux" label="Linux" default>
  ```bash
  ## 1. First Command
