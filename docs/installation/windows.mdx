...
## Overview
For Windows, Cortex can be installed either directly on **Windows** or on **Windows Subsystem for Linux (WSL)**.

:::info
If you're unsure about what is **Windows Subsystem for Linux (WSL)**, please refer to this [article](https://learn.microsoft.com/en-us/windows/wsl/faq).
:::
