...
Cortex.cpp is a C++ command-line interface (CLI) that serves as an alternative to Ollama, capable of running with three different engines: `llama.cpp`, `ONNX`, and `TensorRT-LLM`.
